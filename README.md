...
O objetivo foi estudar educação financeira básica com foco em investimentos para iniciantes, combinando curadoria de fontes, engenharia de prompts e organização do conhecimento em um miniguia estruturado.
...
- Entender o papel da reserva de emergência
...
- Prompts muito genéricos geravam respostas pouco úteis
- Foi necessário adicionar contexto (Brasil + iniciante + exemplos)
- Conteúdos do YouTube precisaram ser filtrados e organizados
...
#### 📈 Renda Fixa
Investimentos onde as regras de rendimento são definidas no momento da aplicação.
...
Recomenda-se:
- 3 a 12 meses de despesas

Deve ser aplicada em ativos:
- Seguros
- Com alta liquidez
- Baixo risco
...
Este projeto permitiu compreender os fundamentos dos investimentos e demonstrou como ferramentas de IA como o NotebookLM podem apoiar o aprendizado ativo.
